    ...
    <div class="products">
        <div class="container">
                <div class="row row-2"  style="margin-top: 20px;">
                    <div class="div">
                        <h2>SẢN PHẨM</h2>
                        <p style="font-size: 12px; font-weight:200 ;">Trang chủ / Phụ kiện</p>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-4 col-4_products">
                        <a href="product-details-2.html"><img src="./assest/images/tên spham-màu nha/Dép/Essential Slipper _ Black.png" alt=""></a>
                        <h4>Black Essential Slipper </h4>
                        <div class="rating">
                    ...
                    <div class="col-4 col-4_products">
                        ...
                        <h4>Yellow Essential Slipper </h4>
                        <div class="rating">
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
                            <i class="fa-solid fa-star"></i>
