                    ...
                    while($row = mysqli_fetch_assoc($result)) {
                        ...
                        if ($countPerRow <= 4) {
                            if($row) {
                                ...
                                $s .= sprintf('<a href="product-details-2.php?ID=%s">
                                <img src="%s" alt=""></a>
                                <h4>%s</h4>'
                                ,$row['ID'], $row['HinhSP'],$row['TenSP']); 
                                $s .= sprintf('<p>%s</p>',  number_format($row['GiaSP'], 0, '', ','));
                                $s .= sprintf(
                                    ' <div class="product-btn">
                                        <div class="option">
                                            ...
                                            <div class="infor">
                                                ...
                                                <a href="product-details-2.php?ID = %s" style="color: #fff ;">Thông tin chi tiết</a>
                                            </div>
                                        </div>
                                    </div>'
                                , $row['ID']);
